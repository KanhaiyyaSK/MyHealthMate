              ...
              <ListGroup>
                {findAppointments(selectedDate).map((appointment, index) => (
                  <>
                    ...
                    >
                      <div>
                        <RiNurseLine style={{ fontSize: "20px" }} />
                        Dr. {appointment.doctorName}
                      </div>
                      <div>
                        <BsFillTelephoneFill /> {appointment.phoneNumber}
                      </div>
                      <div>
                        <BsFillCalendarFill />{" "}
                        {new Date(appointment.timeAndDate).toLocaleDateString(
                          "en-US",
                          { year: "numeric", month: "long", day: "numeric" }
                        )}
                      </div>
                      <div>
                        <ImLocation2 /> {appointment.address}
                      </div>
                      <div>
                        <MdNotes /> {appointment.notes}
                      </div>
                      <Button
                        className="w-25"
                        variant="danger"
