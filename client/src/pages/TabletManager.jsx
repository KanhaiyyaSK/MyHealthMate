...
const TabletManager = () => {
  ...
  const handleFetch = async () => {
    try {
      const response = await axios.get("https://myhealthmate.onrender.com/api/medicines", {
        headers: {
    ...
    <>
      ...
      <div className="page-container">
        ...
        <div style={{ width: "100%" }}>
          ...
          {scrollPosition !== 0 ? (
            <L to={"#"}>
              <BsArrowUpSquareFill id="back-to-top" />
            </L>
          ) : (
            ""
          )}
          ...
          <div
            ref={tempRef}
            className="d-flex flex-row justify-content-evenly medicines-container"
          >
            {/* 
        <div>
          <UpcomingDose />
          ...
          <div
            id="toasts"
            style={{ position: "fixed", zIndex: "10", top: "3%", right: "3%" }}
          >
            <Toast
              onClose={() => {
                setShowToast(false);
            ...
            >
              ...
              <Toast.Body className="text-white">
                Medicine name should be unique
              </Toast.Body>
            </Toast>
