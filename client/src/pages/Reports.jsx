...
const Reports = () => {
  ...
  const fetchReports = async () => {
    ...
    try {
      const response = await axios.get(
        `https://myhealthmate.onrender.com/api/reportsStore?user_id=${user.user_id}`,
        {
          headers: {
  ...
  const handleDelete = async (id, reportName) => {
    try {
      await axios.delete(`https://myhealthmate.onrender.com/api/reportsStore/${id}?user_id=${user.user_id}`, {
        headers: {
          Authorization: `Bearer ${user.token}`,
        },
      });
