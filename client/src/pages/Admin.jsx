            ...
            {fetchedData &&
              fetchedData.map((element, i) => {
                return (
                  <li key={i}>
                    <ul>
                      <li key={element.doctorName}>{element.doctorName}</li>
                      <li key={element.speciality}>{element.speciality}</li>
                      <li key={element.phoneNumber}>{element.phoneNumber}</li>
                      <li key={element.clinicOrHospitalName}>
                        {element.clinicOrHospitalName}
                      </li>
                      <li key={element.address}>{element.address}</li>
                      <li key={element.fees}>{element.fees}</li>
                    </ul>
                  </li>
                );
              })}
